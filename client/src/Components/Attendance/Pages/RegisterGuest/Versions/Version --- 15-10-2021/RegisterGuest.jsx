...
import Model from '../../../EmployeeProtal/UI/Modal/Modal';
import Menu from '../../../EmployeeProtal/UI/Menu/Menu';
import IMG from '../../../../images/desc.jpg';



const Guest_Registration = (props) => {
                        ...
                        <div style={{ maxHeight: '75vh', overflow: 'auto' }}>
                            {
                                res.data.map(
                                    ( val, index ) => {
                                        ...
                                        return (
                                            <div className="Left d-flex align-items-center" key={ index }>
                                                <div>
                                                    <div className="guestsList" onClick={() => SelectGuest()}>
            ...
            <div className="Guest_Registration">
                ...
                <div className="Guest_Image">
                    ...
                    <div className="Dash_Board1 ">
                        <Link to="/attdashboard" className="text-center d-block mb-0 text-dark "><i class="las la-undo"></i></Link>
                    </div>
                </div>
                ...
                <Model show={ModalShow} Hide={ShowPicDiv} content={Guests} />
            </div>
        </>
    )
...
export default Guest_Registration;