...
const DeviceSetup = () => {
    ...
    const OnSelectlocation = ( code ) => {
        ...
        axios.post('/getattdevicebylocation', Data).then(  res => {
            ...
            localStorage.setItem('device_machine', code);
            setStartLoading( false );
        ...
        <>
            ...
            <div className="DeviceSetup">
                <div className="DeviceSetup-content">
                    <h3 className="mb-4">Save this device for attendance</h3>
                    {
                        Locations.map(
                            ( val, index ) => {
                                return (
                    ...
                    <Link to='/attdashboard' className='text-center d-block mb-0 mt-4 mx-auto text-dark border w-50 py-3'>Go To Dashboard</Link>
                </div>
