    ...
    const DiscardRequest = ( poID, e ) => {
        ...
        axios.post('/setpotodiscard', Data).then(
            () => {
                ...
                Data2.append('NotificationBody', sessionStorage.getItem('name') + " has discard your purchase order with id#" + Details[0].po_code + " under this reason '" + e.target['remarks'].value + "'");
    ...
    const ApproveRequest = ( poID, e ) => {
        ...
        axios.post(
            ...
            () => {
                ...
                Data2.append('senderID', sessionStorage.getItem('EmpID'));
                Data2.append('Title', sessionStorage.getItem('name'));
                Data2.append('NotificationBody', sessionStorage.getItem('name') + " has approved your purchase order with id#" + Details[0].po_code);
                axios.post('/newnotification', Data2).then(() => {
