        ...
        if ( window.location.href.split('/').pop().includes('index') )
        {
            axios.post(
                '/store/edit',
                {
                    ...
                    edit_by: sessionStorage.getItem('EmpID'),
                    edit_emp_name: sessionStorage.getItem('name')
                }
            ).then(
                () => {
        ...
        }else
        {
            axios.post(
                '/store/new',
                {
                    ...
                    asset_id: Item.asset_id,
                    date_time: new Date().toString(),
                    insert_by: sessionStorage.getItem('EmpID')
                }
            ).then(
                () => {
    ...
    const RemoveItem = ( e, index ) => {
        ...
        axios.post(
            '/store/remove',
            {
                id: Items[index].id,
                date_time: new Date().toString(),
                remove_by: sessionStorage.getItem('EmpID'),
                remove_emp_name: sessionStorage.getItem('name')
            }
        ).then(
            () => {
