...
const Employee_Drive = () => {
    ...
    useEffect(
        () => {
            ...
            sessionStorage.setItem('SelectedFolderName', '');
            getDrive();
            setInterval(() => {
                getDrive();
            }, 1000);
    ...
    const onFilesSelection = ( event ) => {
        ...
        reader.onload = () => {
            ...
            if( reader.readyState === 2 )
            {
                ...
                Data.append('driveName', sessionStorage.getItem('SelectedFolderName'));
    ...
    const OpenFolder = ( index ) => {
        ...
        sessionStorage.setItem('SelectedFolderid', index.toString());
        setTimeout(() => {
            setData(
                [
                    {
