...
const Leave_Application_Details = () => {
    ...
    const UpdateStatusToWating = ( empID, leaveID, leaveType ) => {
        ...
        Data.append('handleBY', sessionStorage.getItem('EmpID'));
        ...
        axios.post('/updateleavestatustowaiting', Data).then(() => {
            ...
            Data2.append('NotificationBody', sessionStorage.getItem('name') + " has viewed your leave application");
    ...
    const UpdateStatusToAcception = ( empID, leaveID, leaveType ) => {
        ...
        axios.post('/updateleavestatustoaccept', Data).then(() => {
            ...
            if ( leaveType === 'leave' )
            {
                ...
                Data3.append('Title', sessionStorage.getItem('name'));
                Data2.append('NotificationBody', sessionStorage.getItem('name') + " has accepted your leave application");
    ...
    const UpdateStatusToRejection = ( empID, leaveID, leaveType ) => {
        ...
        axios.post('/updateleavestatusreject', Data).then(() => {
            ...
            Data2.append('senderID', 2004);
            Data2.append('Title', sessionStorage.getItem('name'));
            Data2.append('NotificationBody', sessionStorage.getItem('name') + " has rejected your leave application");
            axios.post('/newnotification', Data2).then(() => {
