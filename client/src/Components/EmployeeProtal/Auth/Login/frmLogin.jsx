                    ...
                    <div className="Emp_Login2_Div_Box">
                        ...
                        <div className="LoginDiv">
                            <form onSubmit={props.Login_Div2}>
                                <input autoFocus className="w-100 mb-3 form-control border bg-light" value={props.UserData.LoginID} onChange={props.OnChangeHandler} name="LoginID" required id="standard-basic" label="Login Id" variant="standard" />
                                <div className="w-100 text-right py-3">
                                    <button type='submit' variant="contained" className="w-100 btn" style={{ backgroundColor: "var( --c-green )", color: "white" }}>Next</button>
                                </div>
                            </form>
                        </div>
