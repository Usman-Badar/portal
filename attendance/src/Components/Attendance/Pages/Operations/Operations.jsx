...
const Operations = () => {
    ...
    const endShift = ( id ) => {
        ...
        axios.post( '/timeout', Data ).then( () => {
            ...
            setStartLoading( false );
            spoken.say('Shift End. Thank You');
                            ...
                            <div className="modal-footer">
                                {
                                    ...
                                    ?
                                    <button type="button" className="btn btn-sm btn-dark" data-dismiss="modal" onClick={ () => startBreak(EmployeeeId.id) }>Yes</button>
                                    :
                                    ModalData.type === 'Break end'
                                    ?
                                    <button type="button" className="btn btn-sm btn-dark" data-dismiss="modal" onClick={ () => endBreak(EmployeeeId.id) }>Yes</button>
                                    :
                                    ModalData.type === 'Shift end'
                                    ?
                                    <button type="button" className="btn btn-sm btn-dark" data-dismiss="modal" onClick={ () => endShift(EmployeeeId.id) }>Yes</button>
                                    :
                                    null
                                }
                                <button type="button" className="btn btn-sm btn-dark modalClose" data-dismiss="modal">No</button>
                            </div>
                        </div>
                    </div>
                </div>
